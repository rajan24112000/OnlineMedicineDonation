...
<body>
	...
	<div id="banner">
		...
		<table  class="inner-container" align="center" border="1px;" style="width: 95%;line-height: 35px; background-color: #adc7dc; margin-left: 1%;">
			<tr>
				<th colspan="8"><h2>Users Record</h2></th>
			</tr>
